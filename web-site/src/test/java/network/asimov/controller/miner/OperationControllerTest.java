...
public class OperationControllerTest {
    ...
    public void setUp() {
        ...
        dSLContext.insertInto(Tables.T_MINER_OPERATION)
                ...
                .set(Tables.T_MINER_OPERATION.CREATE_TIME, TimeUtil.currentSeconds())
    ...
    public void tearDown() {
        dSLContext.delete(Tables.T_MINER_OPERATION).where(Tables.T_MINER_OPERATION.ID.eq(1L)).execute();
    }
    ...
    public void getTxStatusByHash() throws Exception {
        String json1 = "{\n" +
                ...
                "}";
        mvc.perform(MockMvcRequestBuilders.post("/miner/transaction/status")
