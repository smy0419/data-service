...
public class ContractControllerTest {
    ...
    public void getContractDetail() throws Exception {
        String json1 = "{}";
        mvc.perform(MockMvcRequestBuilders.post("/ascan/contract/detail")
...
//        ExistContract existContract = mongoTemplate.findOne(new Query(), ExistContract.class);
//        String json3 = "{\"address\":\"" + existContract.getAddress() + "\"}";
//        mvc.perform(MockMvcRequestBuilders.post("/ascan/contract/detail")
//                .contentType(MediaType.APPLICATION_JSON)
//                .accept(MediaType.APPLICATION_JSON_UTF8)
...
//                .andReturn();
    ...
    public void listContractTransaction() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.post("/ascan/contract/transaction/query")
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON_UTF8)
                .content(json1.getBytes())
        )
        ...
        String json4 = "{" +
                " \"address\":\"0x630000000000000000000000000000000000000064\"," +
                "  \"page\": {\n" +
                "    \"index\": 1,\n" +
                "    \"limit\": 10\n" +
                "  }\n" +
    ...
    public void listContract() throws Exception {
        String json1 = "{" +
                ...
                "  }\n" +
                "}";
        mvc.perform(MockMvcRequestBuilders.post("/ascan/contract/query")
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON_UTF8)
                .content(json1.getBytes())
        )
    ...
    public void getContractSource() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.post("/ascan/contract/info")
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON_UTF8)
                .content(json1.getBytes())
        )
    ...
    public void listBalances() throws Exception {
        String json1 = "{}";
        mvc.perform(MockMvcRequestBuilders.post("/ascan/contract/balances")
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON_UTF8)
                .content(json1.getBytes())
        )
