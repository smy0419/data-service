...
public class BlockControllerTest {
	...
	public void queryBlock() throws Exception {
		...
		mvc.perform(
				MockMvcRequestBuilders.post("/ascan/block/query")
	...
	public void getHandledBlockHeight() throws Exception {
		mvc.perform(
				MockMvcRequestBuilders.post("/ascan/block/height")
						.contentType(MediaType.APPLICATION_JSON)
						.accept(MediaType.APPLICATION_JSON_UTF8))
				.andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON_UTF8))
	...
	public void blockDetail1() throws Exception {
		...
		mvc.perform(
				MockMvcRequestBuilders.post("/ascan/block/detail")
						.contentType(MediaType.APPLICATION_JSON)
						.accept(MediaType.APPLICATION_JSON_UTF8)
						.content(json1.getBytes()))
				.andExpect(MockMvcResultMatchers.status().isOk())
		...
		mvc.perform(
				...
				.andExpect(
						MockMvcResultMatchers.jsonPath("$.msg")
								.value("invalid arguments : height or hash not null"))
				.andDo(MockMvcResultHandlers.print())
				.andReturn();
		...
		String json6 =
				"{\"hash\": \"8492587c11a3d379f1adf068b103ba8e8313e2d7342f48ab3bc62c4d5a571475\"}";
		mvc.perform(
				MockMvcRequestBuilders.post("/ascan/block/detail")
						.contentType(MediaType.APPLICATION_JSON)
						.accept(MediaType.APPLICATION_JSON_UTF8)
	...
	@Test
	public void testListBlockTransaction() throws Exception {
		String json1 =
				"{" + "  \"page\": {\n" + "    \"index\": 1,\n" + "    \"limit\": 10\n" + "  }\n" + "}";

		mvc.perform(
				MockMvcRequestBuilders.post("/ascan/block/transaction/list")
						.contentType(MediaType.APPLICATION_JSON)
						.accept(MediaType.APPLICATION_JSON_UTF8)
						.content(json1.getBytes()))
				.andExpect(MockMvcResultMatchers.status().isOk())
